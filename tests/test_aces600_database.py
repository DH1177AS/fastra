"""
Test SQLAlchemyDigitalTwinDB dengan SQLite in-memory.
"""
import pytest
from fastra_core.digital_twin import SQLAlchemyDigitalTwinDB, Snapshot, AuditEvent


def test_sqlalchemy_snapshot_save_get():
    db = SQLAlchemyDigitalTwinDB("sqlite:///:memory:")
    snap = Snapshot(
...
def test_sqlalchemy_audit_save_get():
    db = SQLAlchemyDigitalTwinDB("sqlite:///:memory:")
    event = AuditEvent(
